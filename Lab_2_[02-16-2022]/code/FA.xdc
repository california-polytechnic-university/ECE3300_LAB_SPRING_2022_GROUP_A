...
##Switches
set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS33} [get_ports {fa_nbits_cin}] #not enough ports for an 8bit FA with a carry in port
set_property -dict {PACKAGE_PIN L16 IOSTANDARD LVCMOS33} [get_ports {fa_nbits_port_a[0]}]
set_property -dict {PACKAGE_PIN M13 IOSTANDARD LVCMOS33} [get_ports {fa_nbits_port_a[1]}]
set_property -dict {PACKAGE_PIN R15 IOSTANDARD LVCMOS33} [get_ports {fa_nbits_port_a[2]}]
set_property -dict {PACKAGE_PIN R17 IOSTANDARD LVCMOS33} [get_ports {fa_nbits_port_a[3]}]
set_property -dict {PACKAGE_PIN T18 IOSTANDARD LVCMOS33} [get_ports {fa_nbits_port_b[0]}]
set_property -dict {PACKAGE_PIN U18 IOSTANDARD LVCMOS33} [get_ports {fa_nbits_port_b[1]}]
set_property -dict {PACKAGE_PIN R13 IOSTANDARD LVCMOS33} [get_ports {fa_nbits_port_b[2]}]
set_property -dict {PACKAGE_PIN T8 IOSTANDARD LVCMOS18}  [get_ports {fa_nbits_port_b[3]}]
#set_property -dict {PACKAGE_PIN U8 IOSTANDARD LVCMOS18}  [get_ports {fa_nbits_port_b[1]}]
#set_property -dict {PACKAGE_PIN R16 IOSTANDARD LVCMOS33} [get_ports {fa_nbits_port_b[2]}]
#set_property -dict {PACKAGE_PIN T13 IOSTANDARD LVCMOS33} [get_ports {fa_nbits_port_b[3]}]
#set_property -dict {PACKAGE_PIN H6 IOSTANDARD LVCMOS33}  [get_ports {fa_nbits_port_b[4]}]
#set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS33} [get_ports {fa_nbits_port_b[5]}]
#set_property -dict {PACKAGE_PIN U11 IOSTANDARD LVCMOS33} [get_ports {fa_nbits_port_b[6]}]
#set_property -dict {PACKAGE_PIN V10 IOSTANDARD LVCMOS33} [get_ports {fa_nbits_port_b[7]}]

## LEDs
set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33} [get_ports {fa_nbits_port_sum[0]}]
set_property -dict {PACKAGE_PIN K15 IOSTANDARD LVCMOS33} [get_ports {fa_nbits_port_sum[1]}]
set_property -dict {PACKAGE_PIN J13 IOSTANDARD LVCMOS33} [get_ports {fa_nbits_port_sum[2]}]
set_property -dict {PACKAGE_PIN N14 IOSTANDARD LVCMOS33} [get_ports {fa_nbits_port_sum[3]}]
#set_property -dict {PACKAGE_PIN R18 IOSTANDARD LVCMOS33} [get_ports {fa_nbits_port_sum[4]}]
#set_property -dict {PACKAGE_PIN V17 IOSTANDARD LVCMOS33} [get_ports {fa_nbits_port_sum[5]}]
#set_property -dict {PACKAGE_PIN U17 IOSTANDARD LVCMOS33} [get_ports {fa_nbits_port_sum[6]}]
#set_property -dict {PACKAGE_PIN U16 IOSTANDARD LVCMOS33} [get_ports {fa_nbits_port_sum[7]}]
...
set_property -dict {PACKAGE_PIN V11 IOSTANDARD LVCMOS33} [get_ports {fa_nbits_port_cout}]
...
#set_input_delay -clock [get_clocks sys_clk_pin] -min -add_delay 1.000 [get_ports {buttons[*]}]
#set_input_delay -clock [get_clocks sys_clk_pin] -max -add_delay 1.000 [get_ports {buttons[*]}]
#set_input_delay -clock [get_clocks sys_clk_pin] -min -add_delay 1.000 [get_ports {switches[*]}]
#set_input_delay -clock [get_clocks sys_clk_pin] -max -add_delay 1.000 [get_ports {switches[*]}]
...
#set_output_delay -clock [get_clocks sys_clk_pin] -min -add_delay 1.000 [get_ports {leds[*]}]
#set_output_delay -clock [get_clocks sys_clk_pin] -max -add_delay 1.000 [get_ports {leds[*]}]
#set_output_delay -clock [get_clocks sys_clk_pin] -min -add_delay 1.000 [get_ports {rgb_leds[*]}]
#set_output_delay -clock [get_clocks sys_clk_pin] -max -add_delay 1.000 [get_ports {rgb_leds[*]}]
#set_output_delay -clock [get_clocks sys_clk_pin] -min -add_delay 1.000 [get_ports {sseg[*]}]
#set_output_delay -clock [get_clocks sys_clk_pin] -max -add_delay 1.000 [get_ports {sseg[*]}]
#set_output_delay -clock [get_clocks sys_clk_pin] -min -add_delay 1.000 [get_ports {sseg_an[*]}]
#set_output_delay -clock [get_clocks sys_clk_pin] -max -add_delay 1.000 [get_ports {sseg_an[*]}]
